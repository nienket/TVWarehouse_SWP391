 ...
 * @author 84348
 */
@WebServlet(name = "DeleteOrderVirtualSellerController", urlPatterns = {"/DeleteOrderVirtualSellerController"})
public class DeleteOrderVirtualSellerController extends HttpServlet {
