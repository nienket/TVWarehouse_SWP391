 ...
 * @author 84348
 */
@WebServlet(name = "SendOrderAccountController", urlPatterns = {"/SendOrderAccountController"})
public class SendOrderAccountController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DAOIssue dao = new DAOIssue();
                List<UserOrder> listInventory = dao.getListSearchOrderManager(search);
                if (listInventory.size() > 0) {
                    session.setAttribute("LIST_ORDER_ACCOUNT", listInventory);
                    url = SUCCESS;
                } else {
