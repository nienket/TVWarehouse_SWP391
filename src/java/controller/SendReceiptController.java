 ...
 * @author 84348
 */
@WebServlet(name = "SendReceiptController", urlPatterns = {"/SendReceiptController"})
public class SendReceiptController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DAOReceipt dao = new DAOReceipt();
                List<UserReceipt> listInventory = dao.getListSearchStatusAccount(search);
                if (listInventory.size() > 0) {
                    session.setAttribute("LIST_RECEIPT", listInventory);
                    url = SUCCESS;
                } else {
