 ...
 * @author 84348
 */
@WebServlet(name = "SendStatusIssueAccountController", urlPatterns = {"/SendStatusIssueAccountController"})
public class SendStatusIssueAccountController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<UserIssueS> listInventory = dao.getListSearchIssueStatus(search);
            if(listInventory.size() >0){
                session.setAttribute("LIST_ISSUE", listInventory);
                url = SUCCESS;
            }else{
