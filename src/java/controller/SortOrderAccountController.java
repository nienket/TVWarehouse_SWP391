 ...
 * @author 84348
 */
@WebServlet(name = "SortOrderAccountController", urlPatterns = {"/SortOrderAccountController"})
public class SortOrderAccountController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<UserOrder> receipt = (List<UserOrder>) session.getAttribute("LIST_ORDER_ACCOUNT");
