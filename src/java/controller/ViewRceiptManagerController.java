 ...
 * @author 84348
 */
@WebServlet(name = "ViewRceiptManagerController", urlPatterns = {"/ViewRceiptManagerController"})
public class ViewRceiptManagerController extends HttpServlet {

    private static final String ERROR="MainController?action=SearchReceiptManager&receiptID=";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(listDetail.size() >0){
                request.setAttribute("LIST_DETAIL_RECEIPT_MANAGER", listDetail);
                url = SUCCESS;
            }
        }catch(Exception e){
