<%-- 
    ...
    Created on : Jul 23, 2022, 12:33:34 PM
    Author     : 84348
--%>
                ...
                <div class=" header-item">
                    ...
                    <div class="dropdown inline-block ">
                        ...
                        <ul class="dropdown-menu menu-container" >
                            ...
                            <li>
                                <a class=" menu-element dropdown-item" href="homeManager.jsp">
                            ...
                            <li>
                                <a class=" menu-element dropdown-item " href="createProductManager.jsp">
                                    <span class="iconify" data-icon="gridicons:create"></span>
                            ...
                            <li>
                                <a class=" menu-element dropdown-item " href="MainController?action=SearchReceiptManager&receiptID=">
                                    <span class="iconify" data-icon="gridicons:create"></span>
...
<!--                            <li>
                                <a class=" menu-element dropdown-item " href="MainController?action=SearchIssueManager&OrderI=">
                                    <span class="iconify" data-icon="gridicons:create"></span>
