<%-- 
    ...
    Created on : Jul 23, 2022, 12:22:09 PM
    Author     : 84348
--%>
                ...
                <div class=" header-item">
                    ...
                    <div class="dropdown inline-block ">
                        ...
                        <ul class="dropdown-menu menu-container" >
                            ...
                            <li>
                                <a class=" menu-element dropdown-item" href="homeSeller.jsp">
                            ...
                            <h1 class="dropdown-header" id="dropdown-header">Order</h1>
                            <li>
                                <a class=" menu-element dropdown-item " href="MainController?action=SearchOrderSeller&OrderI=">
                                    <span class="iconify" data-icon="gridicons:create"></span>
                                    <span >List Order</span>
                                </a>
                            </li>
                            <li>
                                <a class=" menu-element dropdown-item " href="createOrderSeller.jsp">
                                    <span class="iconify" data-icon="gridicons:create"></span>
